defmodule ExMon.Game.Actions.Heal do
  ...
  defp set_life(life, player) when life > 100, do: updade_player_life(player, 100)
  defp set_life(life, player), do: updade_player_life(player, life)

  defp updade_player_life(player, life) do
    player
    |> Game.fetch_player()
    |> Map.put(:life, life)
